  ...
  handleUpload(e) {
    ...
    this.props.validatePhoto(validationData).then(() => {
      if (Object.values(this.props.errors).length === 0) {
        ...
        formData.append("lat", this.props.file.metaData.lat || this.props.locations[0].longitude);
        formData.append("long", this.props.file.metaData.long || this.props.locations[0].latitude);
